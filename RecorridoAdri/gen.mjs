...
const POI = {
  ...
  "EEM-18177-B": { n: "Pantalla LED Toreo \xB7 Perif\xE9rico", lat: 19.460182, lng: -99.222014, med: "17.28 \xD7 8.64 m", imp: 5662e3, tipo: "Pantalla LED digital", t: 0, dir: "Blvd. M. \xC1vila Camacho (Perif\xE9rico) y Av. Emiliano Zapata, Naucalpan", aud: "Vehicular masivo \xB7 Perif\xE9rico / Toreo", niv: "Alto", ben: "Entrada a CDMX por Perif\xE9rico: una de las vialidades con m\xE1s aforo del pa\xEDs.", cad: "Walmart, Bodega Aurrer\xE1 y Soriana a la redonda", wm: "assets/sitios/EEM-18177-B-wm.jpg" },
  ...
  "EEM-17672-A": { n: "Pantalla LED Paseo Interlomas", lat: 19.396232, lng: -99.281112, med: "15.36 \xD7 3.84 m", imp: 1835257, tipo: "Pantalla LED", t: 48e4, dir: "Vialidad frente a Paseo Interlomas, Huixquilucan", aud: "Shoppers \xB7 frente a Liverpool", niv: "Medio", ben: "Impacto directo sobre shoppers de alto poder adquisitivo en el corredor comercial.", cad: "Walmart, City Market y Chedraui a la redonda", wm: "assets/sitios/EEM-17672-A-wm.jpg" },
  "EEM-17672-B": { n: "Puente Paseo Interlomas", lat: 19.3968, lng: -99.2816, med: "15.10 \xD7 3.80 m", imp: 9e5, tipo: "Puente peatonal", t: 32e4, dir: "Frente a Hospital \xC1ngeles Interlomas, Huixquilucan", aud: "Vehicular \xB7 Hospital \xC1ngeles", niv: "T\xE1ctico", ben: "Refuerzo t\xE1ctico frente a Hospital \xC1ngeles y Paseo Interlomas.", cad: "Walmart y Chedraui a la redonda", wm: "assets/sitios/EEM-17672-B-wm.jpg" },
  ...
  "EEM-17427-B": { n: "Puente Hueyetlaco", lat: 19.387794, lng: -99.278823, med: "10.60 \xD7 5.20 m", imp: 85e4, tipo: "Puente peatonal", t: 28e4, dir: "Circulaci\xF3n Santa Fe hacia Interlomas, Huixquilucan", aud: "Vehicular \xB7 Santa Fe\u2013Interlomas", niv: "T\xE1ctico", ben: "Captura el flujo diario Santa Fe\u2013Interlomas.", cad: "Walmart y Bodega Aurrer\xE1 a la redonda", wm: "assets/sitios/EEM-17427-B-wm.jpg" },
  "EEM-15935-B": { n: "Unipolar Vialidad de la Barranca", lat: 19.388173, lng: -99.2786, med: "12.90 \xD7 10.80 m", imp: 14e5, tipo: "Unipolar", t: 42e4, dir: "Vialidad de la Barranca hacia Santa Fe, Huixquilucan", aud: "Alta plusval\xEDa \xB7 Bosques de las Lomas", niv: "Medio", ben: "Audiencia de alt\xEDsima plusval\xEDa rumbo a Santa Fe y Bosques.", cad: "Walmart, City Market y Soriana a la redonda", wm: "assets/sitios/EEM-15935-B-wm.jpg" }
};
const OPORT = [
  { id: "OPP-HAMB", n: "Landmark Hamb\xFArgo \xB7 Col. Ju\xE1rez", med: "12.9 \xD7 7.2 m \xB7 Pantalla LED", imp: 41e5, precio: "$750,000", t: 75e4, img: SS + "OPP-HAMB.jpg", dir: "Hamburgo esq. Florencia, Col. Ju\xE1rez, CDMX" },
  { id: "OPP-MEGA", n: "Mega Valla \xB7 Churubusco", med: "108 \xD7 3.05 m", imp: 12e5, precio: "$630,000", t: 63e4, img: SS + "MPCX-19072-A.jpg", dir: "Calz. de Tlalpan esq. R\xEDo Churubusco, Coyoac\xE1n, CDMX" },
  { id: "OPP-SAT", n: "Muro Galer\xEDas Sat\xE9lite \xB7 Fachada", med: "44 \xD7 8 m \xB7 3 caras", imp: 54e5, precio: "$750,000", t: 75e4, img: SS + "OPP-SAT.jpg", dir: "Perif\xE9rico Norte, Galer\xEDas Sat\xE9lite, Naucalpan" },
  { id: "OPP-TOREO", n: "Landmark Toreo \xB7 Perif\xE9rico", med: "43.4 \xD7 5.2 m", imp: 63e5, precio: "$462,000", t: 462e3, img: SS + "OPP-TOREO.jpg", dir: "Perif\xE9rico Norte, Toreo, Naucalpan" },
  { id: "OPP-GLORIETA", n: "Landmark Glorieta Interlomas \xB7 Walmart", med: "Glorieta 60 \xD7 29 m \xB7 Spark 19 m", imp: 22e5, precio: "$1,200,000", t: 12e5, img: SS + "GLORIETA-LMK.jpg", dir: "Glorieta Av. San Mateo Santa Rosa / Blvd. Palmas Hills, Interlomas" },
  { id: "OPP-PANT3D", n: "Pantalla 3D \xB7 Paseo Interlomas", med: "Pantalla LED \xB7 DOOH 3D", imp: 1835257, precio: "Cotizar", t: 0, img: SS + "OPP-DOOH.jpg", dir: "Paseo Interlomas, Huixquilucan" }
];
...
function interesCards(pool) {
  return pool.map((it) => {
    ...
    const geo = GEO + "?q=" + enc(it.dir || it.n);
...
function poolInteres(d) {
  ...
  const sitios = Object.keys(POI).filter((id) => !used.has(id)).map((id) => ({ id, n: POI[id].n, med: POI[id].med, imp: POI[id].imp, t: POI[id].t, precio: POI[id].t ? fmt(POI[id].t) : "Cotizar", img: BASE + "/" + POI[id].wm, dir: POI[id].dir }));
